...
@powershell (new-object System.Net.WebClient).DownloadFile('https://github.com/Graylog2/collector-sidecar/releases/download/0.1.4/collector_sidecar_installer_0.1.4-1.exe','%temp%\Sidecar.exe')"
